...
public class MBManager {
	...
	public static void replyMsg()
		...
		if (MBMessageLocalServiceUtil.getGroupMessagesCount(
			groupId, WorkflowConstants.STATUS_APPROVED) <= 0) {
			return;
		}

		int rand =
			(int) (Math.random() * (double) MBMessageLocalServiceUtil.getGroupMessagesCount(
				groupId, WorkflowConstants.STATUS_APPROVED));
		MBMessage msg =
			MBMessageLocalServiceUtil.getGroupMessages(
